...
function App() {
  const [valueOfTodosStatus, setValueOfTodosStatus] = useState({ all: 0, inWork: 0, completed: 0 }) // объект с количеством тудушек
  ...
  return (
    <div className="todo">
      ...
      <TodoFilter render={renderTodos} valueAll={valueOfTodosStatus.all} valueInWork={valueOfTodosStatus.inWork} valueCompleted={valueOfTodosStatus.completed}/>
